	...
	return (
		<div>
			...
			<div className="my-[200px]">
				...
				<div className='text-2xl my-[100] font-semibold text-center text-light-blue'>
					My Instagram: <a href='https://www.instagram.com/k.a.l.o.p.s.i.a__/'> @k.a.l.o.p.s.i.a__</a>
				</div>
			</div>
